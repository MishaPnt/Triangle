...
namespace Triangles
{
    abstract class GetTriangles
    {
        ...
        public abstract double AreaIsoscel();
        public abstract double PerimetrEquilateral();
        public abstract double AreaEquilateral();
        public abstract double PerimetrRectangular();
        public abstract double AreaIsosceles();
        public abstract double PerimetrIsosceles();
        public int a;
        public int b;
        public int angle;
